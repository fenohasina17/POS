    ...
    <template v-else-if="terminal">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <article v-for="card in statsCards" :key="card.label" class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <span :class="['mb-3 flex h-10 w-10 items-center justify-center rounded-xl', card.iconBg]" v-html="card.icon"></span>
...
// Icônes inline
// Chaînes SVG brutes rendues via v-html (voir MainLayout.vue pour le détail
// du bug de compilation Vue à l'exécution que ça évite en production)
...
const IconCurrency = `<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`
const IconSync     = `<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>`
const IconClock    = `<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`
